  ...
  try {
    ...
    return NextResponse.json({
      revenue: {
        ...
        prescriptionSales: sales.filter((s: any) => s.prescriptionId).reduce((sum: number, sale: any) => sum + sale.totalPrice, 0),
        otcSales: sales.filter((s: any) => !s.prescriptionId).reduce((sum: number, sale: any) => sum + sale.totalPrice, 0),
      },
      costOfGoodsSold: {
